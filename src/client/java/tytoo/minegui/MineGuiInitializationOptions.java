...
public record MineGuiInitializationOptions(
    ...
    public MineGuiInitializationOptions(
        ...
        this(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, configPathStrategy, defaultCursorPolicyId, DockspaceCustomizer.noop());
    }
    ...
    public MineGuiInitializationOptions(
        ...
        this(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, ConfigPathStrategies.sandboxed(), defaultCursorPolicyId, DockspaceCustomizer.noop());
    }

    public MineGuiInitializationOptions(boolean loadGlobalConfig, String configNamespace) {
        this(loadGlobalConfig, false, configNamespace, ConfigFeatureProfile.all(), ConfigPathStrategies.sandboxed(), MGCursorPolicies.emptyId(), DockspaceCustomizer.noop());
    }

    public MineGuiInitializationOptions(boolean loadGlobalConfig, boolean ignoreGlobalConfig, String configNamespace) {
        this(loadGlobalConfig, ignoreGlobalConfig, configNamespace, ConfigFeatureProfile.all(), ConfigPathStrategies.sandboxed(), MGCursorPolicies.emptyId(), DockspaceCustomizer.noop());
    }

    public static MineGuiInitializationOptions defaults() {
        return new MineGuiInitializationOptions(true, false, MineGuiCore.ID, ConfigFeatureProfile.all(), ConfigPathStrategies.sandboxed(), MGCursorPolicies.emptyId(), DockspaceCustomizer.noop());
    }

    public static MineGuiInitializationOptions skipGlobalConfig() {
        return new MineGuiInitializationOptions(false, false, MineGuiCore.ID, ConfigFeatureProfile.all(), ConfigPathStrategies.sandboxed(), MGCursorPolicies.emptyId(), DockspaceCustomizer.noop());
    }

    public static MineGuiInitializationOptions ignoringGlobalConfig() {
        return new MineGuiInitializationOptions(false, true, MineGuiCore.ID, ConfigFeatureProfile.all(), ConfigPathStrategies.sandboxed(), MGCursorPolicies.emptyId(), DockspaceCustomizer.noop());
    }
    ...
    public MineGuiInitializationOptions withNamespace(String namespace) {
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, namespace, featureProfile, configPathStrategy, defaultCursorPolicyId, dockspaceCustomizer);
    }

    public MineGuiInitializationOptions withLoadGlobalConfig(boolean loadGlobalConfig) {
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, configPathStrategy, defaultCursorPolicyId, dockspaceCustomizer);
    }
    ...
    public MineGuiInitializationOptions withFeatureProfile(ConfigFeatureProfile profile) {
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, configNamespace, profile, configPathStrategy, defaultCursorPolicyId, dockspaceCustomizer);
    }
    ...
    public MineGuiInitializationOptions withDefaultCursorPolicy(Identifier policyId) {
        ...
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, configPathStrategy, normalized, dockspaceCustomizer);
    }
    ...
    public MineGuiInitializationOptions withDockspaceCustomizer(DockspaceCustomizer customizer) {
        ...
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, configPathStrategy, defaultCursorPolicyId, normalized);
    }
    ...
    public MineGuiInitializationOptions withConfigPathStrategy(ConfigPathStrategy strategy) {
        ...
        return new MineGuiInitializationOptions(loadGlobalConfig, ignoreGlobalConfig, configNamespace, featureProfile, normalized, defaultCursorPolicyId, dockspaceCustomizer);
    }
}
