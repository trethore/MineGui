...
public final class ConfigService {
    ...
    ConfigService refreshWith(Path newConfigRoot, ConfigPathStrategy defaultStrategy) {
        ConfigService refreshed = new ConfigService(namespace, newConfigRoot, defaultStrategy);
